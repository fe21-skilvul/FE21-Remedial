      ...
      <div className="min-h-screen">
        <div className=" bg-zinc-100 ml-12 mt-0 pt-12 pb-20">
          <div className="bg-zinc-200 ml-14 py-20 pl-10 rounded-md">
            <h1 className="w-1/3 mb-4 text-2xl font-light text-gray-900 md:text-5xl md:tracking-tight md:leading-tight lg:text-5xl lg:tracking-tight lg:leading-tight dark:text-black">
              Tambah Wawasan Dengan Membaca Blog Kami
            </h1>
            <hr className="h-px my-8 bg-gray-200 border-0 dark:bg-gray-700" />
            <p className=" mb-8 text-lg font-extralight text-gray-900 lg:text-xl dark:text-black">
