...
function AboutPage() {
  return (
    <div>
        <section id="about" className="pt-16 pb-28 bg-gray-300 flex flex-col justify-center items-center">
            <h1 className="font-libre text-4xl text-black text-center my-4">About Us</h1>
