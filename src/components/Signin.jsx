...
const Signin = () => {
  ...
  return (
    ...
    //   <div className="bg-white border-2 rounded-lg shadow-md max-w-[400px] mx-auto my-16 p-4">
    //     <div>
      ...
      <section class="bg-gray-50 min-h-screen flex items-center justify-center">
        <div class="bg-gray-100 flex rounded-2xl shadow-lg max-w-3xl p-5 items-center">
          ...
          <div class="md:w-1/2 px-8 md:px-16">
            <h2 class="font-bold text-2xl text-[#002D74]">Masuk</h2>
            <p class="text-xs mt-4 text-[#002D74]">
              Selamat Datang di Remedial Masukan Email dan Password dengan
              Benar!
            </p>
